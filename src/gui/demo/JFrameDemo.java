...
public class JFrameDemo {
	...
	public static void main(String[] args) {
		...
		jFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // sets what operation is performed once we close the window
		...
		ImageIcon image = new ImageIcon("python.png"); // sets jframe's icon
